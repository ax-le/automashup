...
def mashup_script(song_path_1, song_path_2, stored_data_folder = default_stored_data_path, mashup_save_folder = default_save_mashup_path, verbose = True):
    ...
    mashup_vocals = Track(song_name_1, 'vocals', vocals_4stems_1[0], vocals_4stems_1[1], metadata_1['bpm'], metadata_1['beats'], metadata_1['downbeats'], metadata_1['key'], metadata_1['segments'], metadata_1['path'])
    ...
    if verbose:
        print("Initializing the Track object.")
    mashup_bass = Track(song_name_2, 'bass', bass_4stems_2[0], bass_4stems_2[1], metadata_2['bpm'], metadata_2['beats'], metadata_2['downbeats'], metadata_2['key'], metadata_2['segments'], metadata_2['path'])
    mashup_drums = Track(song_name_2, 'drums', drums_4stems_2[0], drums_4stems_2[1], metadata_2['bpm'], metadata_2['beats'], metadata_2['downbeats'], metadata_2['key'], metadata_2['segments'], metadata_2['path'])
    mashup_other = Track(song_name_2, 'other', other_4stems_2[0], other_4stems_2[1], metadata_2['bpm'], metadata_2['beats'], metadata_2['downbeats'], metadata_2['key'], metadata_2['segments'], metadata_2['path'])
    ...
    mashup_result_vanilla = mashupper.mashup_adjust_songscale(vocal_track_in=mashup_vocals, instrumental_tracks_in=[mashup_bass, mashup_drums, mashup_other], save_folder_path = default_save_mashup_path)
    ...
    mashup_result_repitch_vocals_to_instrumental = mashupper.mashup_adjust_songscale(vocal_track_in=mashup_vocals, instrumental_tracks_in=[mashup_bass, mashup_drums, mashup_other], save_folder_path = default_save_mashup_path, repitch='vocals_to_instrumental')
    ...
    mashup_result_repitch_instrumental_to_vocals = mashupper.mashup_adjust_songscale(vocal_track_in=mashup_vocals, instrumental_tracks_in=[mashup_bass, mashup_drums, mashup_other], save_folder_path = default_save_mashup_path, repitch='instrumental_to_vocals')
    ...
    if verbose:
        print("Thirdly, aligning the instrumental to the vocal structure, but the instrumental is now 2 stems separated instead of 4.")
        print("Mashup without repitching.")
