...
from automashup.src.tempo_utils import (
    time_stretch_audio,
    time_stretch_to_match_timesteps,
    time_stretch_to_match_downbeats
)



class TestTimeStretchAudio(unittest.TestCase):

    """Tests for the time_stretch_audio function."""


    def test_time_stretch_audio_speed_up(self):
        ...
        result = time_stretch_audio(audio, sr, orig_tempo=100, ref_tempo=200)
    ...
    def test_time_stretch_audio_slow_down(self):
        ...
        result = time_stretch_audio(audio, sr, orig_tempo=200, ref_tempo=100)
    ...
    def test_time_stretch_audio_same_tempo(self):
        ...
        result = time_stretch_audio(audio, sr, orig_tempo=120, ref_tempo=120)
...
class TestTimeStretchToMatchTimesteps(unittest.TestCase):

    """Tests for the time_stretch_to_match_timesteps function."""
    ...
    def test_match_timesteps_basic(self):
        ...
        # This function relies on time_stretch_to_match_length which has a bug

        # (uses audio.sr which doesn't exist for numpy arrays)

        # We'll test via mocking

        with patch('automashup.src.tempo_utils.time_stretch_to_match_length') as mock_match:
            ...
            result = time_stretch_to_match_timesteps(audio, sr, ref_start=0, ref_end=100)
            

            # Should call time_stretch_to_match_length with duration = 100 - 0 = 100
    ...
    def test_match_timesteps_with_offset(self):
        ...
        with patch('automashup.src.tempo_utils.time_stretch_to_match_length') as mock_match:
            ...
            result = time_stretch_to_match_timesteps(audio, sr,ref_start=50, ref_end=100)
...
class TestTimeStretchToMatchDownbeats(unittest.TestCase):

    """Tests for the time_stretch_to_match_downbeats function."""
    ...
    def test_match_downbeats_equal_bars(self):
        ...
        with patch('automashup.src.tempo_utils.time_stretch_to_match_timesteps') as mock_accel, \
            ...
            result = time_stretch_to_match_downbeats(barwise_audio, sr, ref_downbeats)
            

            # Should call time_stretch_to_match_timesteps twice
    ...
    def test_match_downbeats_empty_bar_raises_error(self):
        ...
        with self.assertRaises(ValueError) as context:
            ...
            time_stretch_to_match_downbeats(barwise_audio, sr, ref_downbeats)
